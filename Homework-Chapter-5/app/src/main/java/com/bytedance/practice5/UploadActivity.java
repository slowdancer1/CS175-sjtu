...
public class UploadActivity extends AppCompatActivity {
    ...
    private void submit() {
        ...
        MultipartBody.Part image_part=MultipartBody.Part.createFormData("image","cover.png",RequestBody.create(MediaType.parse("multipart/form-data"),coverImageData));
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    Toast.makeText(UploadActivity.this,"上传异常！",Toast.LENGTH_SHORT).show();
